...
{
    public class changeorder : Controller
    {
        private readonly ILogger<changeorder> _logger;
        Helper helper;
        // Object DataSet
        DataSet ds;
        ...
        public changeorder(ILogger<changeorder> logger)
        {
            // Inisialisasi Object
            helper = new Helper();
            ds = new DataSet();
        ...
        public IActionResult changeOrder(UserModel user)
        {
            ds = new DataSet();
            param = new NpgsqlParameter[] {
