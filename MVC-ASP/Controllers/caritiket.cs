...
{
    public class caritiket : Controller
    {
        private readonly ILogger<caritiket> _logger;
        Helper helper;
        // Object DataSet
        DataSet ds;
        ...
        public caritiket(ILogger<caritiket> logger)
        {
            // Inisialisasi Object
            helper = new Helper();
            ds = new DataSet();
        ...
        public IActionResult CariTiket(UserModel user)
        {
            ds = new DataSet();
            param = new NpgsqlParameter[] {
